...
Type.registerNamespace('Sys.WebForms');
Sys.WebForms.Res={
"PRM_UnknownToken":"رمز غير معروف: \u0027{0}\u0027.",
"PRM_MissingPanel":"تعذر العثور على UpdatePanel بالمعرف \u0027{0}\u0027. إذا كان يجري تحديثه بشكل ديناميكي، فإنه يجب أن يتم وضعه بداخل UpdatePanel آخر.",
"PRM_ServerError":"حدث خطأ غير معروف أثناء معالجة الطلب على الخادم. كان رمز الحالة الذي تم إرجاعه من الخادم هو: {0}",
"PRM_ParserError":"لا يمكن تحليل الرسالة التي تم تلقيها من الخادم.",
"PRM_TimeoutError":"انتهت مهلة طلب الخادم.",
"PRM_ParserErrorDetails":"خطأ أثناء التحليل بجوار \u0027{0}\u0027.",
"PRM_CannotRegisterTwice":"تعذر بدء تشغيل PageRequestManager أكثر من مرة."
};
